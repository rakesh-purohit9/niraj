                  ...
                  <div className="bg-white_A700 flex md:flex-1 items-center justify-start p-[32px] sm:px-[20px] rounded-[4px] shadow-bs md:w-[100%] w-[24%]">
                    <div className="flex flex-col items-start justify-start mb-[8px] w-[100%]">
                      <div className="flex flex-col gap-[24px] items-center justify-start w-[100%]">
                        ...
                        <Button
                          className="bg-deep_orange_300 flex items-center justify-center pl-[31px] pr-[35px] py-[17px] rounded-[24px] sm:px-[20px] text-center"
                          rightIcon={
                            <Img
                  ...
                  <div className="bg-white_A700 flex md:flex-1 items-center justify-start p-[26px] sm:px-[20px] rounded-[4px] shadow-bs md:w-[100%] w-[75%]">
                    <div className="flex flex-col gap-[30px] items-center justify-start mb-[6px] md:w-[100%] w-[99%]">
                      ...
                      <div className="h-[642px] relative w-[100%]">
                        ...
                        <div className="border-[1px] border-indigo_51 border-solid flex flex-col gap-[54px] items-center justify-start mt-[auto] mx-[auto] p-[121px] sm:px-[20px] md:px-[40px] w-[100%]">
                          <Img
                            src="images/img_19.svg"
                            className="h-[119px] w-[auto]"
                            alt="Nineteen"
                          />
                          <Text
                            className="font-normal mb-[160px] not-italic text-bluegray_400 text-left w-[auto]"
                            as="h5"
                            variant="h5"
                          >
