        ...
        <div className="flex md:flex-col flex-row md:gap-[20px] items-start justify-evenly w-[100%]">
          <aside className="flex flex-col md:hidden justify-start md:px-[20px] w-[241px]">
            <div className="bg-white_A700 flex flex-col gap-[36px] items-center justify-start p-[29px] sm:px-[20px] w-[100%]">
              <Img
                ...
                alt="Logo"
              />
              <div className="flex flex-col items-start justify-start mb-[459px] md:w-[100%] w-[87%]">
          ...
          <div className="flex flex-1 flex-col items-center justify-start md:px-[20px] w-[100%]">
            ...
            <div className="bg-gray_51 flex items-center justify-end p-[23px] sm:px-[20px] w-[100%]">
              <div className="flex flex-col gap-[35px] items-center justify-start mb-[8px] mt-[14px] w-[100%]">
                ...
                <div className="flex md:flex-col flex-row gap-[20px] items-center justify-between w-[100%]">
                  <div className="sm:h-[797px] h-[803px] md:h-[903px] relative md:w-[100%] w-[67%]">
                    <div className="absolute bottom-[0] flex flex-col gap-[11px] items-start justify-start left-[7%] pr-[4px] pt-[4px] w-[auto]">
                      <Text
                    ...
                    <div className="absolute bg-white_A700 flex flex-col gap-[32px] h-[max-content] inset-[0] items-start justify-center m-[auto] p-[31px] sm:px-[20px] rounded-[4px] shadow-bs w-[100%]">
                      ...
                      <div className="flex flex-col items-start justify-start mb-[277px] w-[100%]">
                        <div className="flex flex-col gap-[20px] items-start justify-start md:w-[100%] w-[21%]">
                          <CheckBox
                        ...
                        <div className="flex flex-col gap-[27px] items-center justify-start mt-[34px] w-[100%]">
                          <div className="flex flex-col gap-[12px] items-start justify-start w-[100%]">
                            ...
                            <div className="bg-white_A700 border-[1px] border-indigo_51 border-solid flex items-start justify-end p-[16px] rounded-[4px] w-[100%]">
                              <Input
                                className="font-normal not-italic p-[0] text-[16px] placeholder:text-bluegray_400 text-bluegray_400 text-left w-[100%]"
                                wrapClassName="flex md:ml-[0] ml-[4px] mt-[2px] pb-[2px] pt-[3px] sm:ml-[0] sm:w-[100%] w-[33%]"
                                type="number"
                                name="Frame"
                          ...
                          <div className="flex md:flex-col flex-row gap-[24px] items-center justify-between w-[100%]">
                            <div className="flex md:flex-1 flex-col gap-[12px] items-start justify-start md:w-[100%] w-[49%]">
                              ...
                              <div className="bg-white_A700 border-[1px] border-indigo_51 border-solid flex items-start justify-start p-[16px] rounded-[4px] w-[100%]">
                                <Input
                                  className="font-normal not-italic p-[0] text-[16px] placeholder:text-bluegray_400 text-bluegray_400 text-left w-[100%]"
                                  wrapClassName="flex md:ml-[0] ml-[4px] pb-[2px] pl-[0] pr-[3px] pt-[5px] sm:ml-[0] sm:w-[100%] w-[54%]"
                                  type="text"
                                  name="Frame One"
                            ...
                            <div className="flex md:flex-1 flex-col gap-[12px] items-start justify-start md:w-[100%] w-[49%]">
                              ...
                              <Input
                                className="font-normal not-italic p-[0] text-[16px] placeholder:text-bluegray_400 text-bluegray_400 text-left w-[100%]"
                                wrapClassName="bg-white_A700 border-[1px] border-indigo_51 border-solid flex pb-[22px] pl-[20px] pr-[35px] pt-[17px] rounded-[4px] sm:pr-[20px] w-[100%]"
                                name="Frame Two"
                                placeholder="***"
                                prefix={
                                  <Img
                  ...
                  <div className="flex md:flex-1 flex-col gap-[32px] items-center justify-start md:w-[100%] w-[33%]">
                    <div className="bg-white_A700 flex items-center justify-start p-[32px] sm:px-[20px] rounded-[4px] shadow-bs w-[100%]">
                      <div className="flex flex-col items-center justify-start w-[100%]">
                        ...
                        <Line className="bg-indigo_51 h-[1px] mt-[32px] w-[100%]" />
                        <Input
                          className="font-normal not-italic pl-[20px] pr-[12px] py-[20px] text-[16px] placeholder:text-bluegray_400 text-bluegray_400 text-left w-[100%]"
