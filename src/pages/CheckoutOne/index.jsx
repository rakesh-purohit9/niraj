        ...
        <div className="flex md:flex-col flex-row md:gap-[20px] items-center justify-evenly w-[100%]">
          ...
          <div className="flex flex-1 flex-col items-center justify-start md:px-[20px] w-[100%]">
            ...
            <div className="bg-gray_51 flex items-center justify-end p-[23px] sm:px-[20px] w-[100%]">
              <div className="flex flex-col gap-[36px] items-center justify-start mb-[8px] mt-[14px] md:w-[100%] w-[99%]">
                ...
                <div className="flex md:h-[777px] h-[802px] justify-end relative w-[100%]">
                  <div className="flex flex-col gap-[11px] h-[100%] items-start justify-start ml-[54px] mt-[auto] pr-[4px] pt-[4px] w-[auto]">
                    <Text
                  ...
                  <div className="absolute bg-white_A700 flex flex-col md:gap-[40px] gap-[65px] h-[100%] inset-[0] items-center justify-center m-[auto] p-[111px] sm:px-[20px] md:px-[40px] rounded-[4px] shadow-bs w-[100%]">
                    <Img
                    ...
                    <div className="flex flex-col gap-[32px] items-center justify-start mb-[143px] md:w-[100%] w-[56%]">
                      <div className="flex flex-col gap-[8px] justify-start w-[100%]">
                        <Text
                          className="md:ml-[0] ml-[48px] text-bluegray_900 text-left w-[auto]"
                          as="h2"
                          variant="h2"
                        >
                      ...
                      <Button className="bg-deep_orange_300 cursor-pointer font-bold min-w-[207px] py-[15px] rounded-[24px] text-[14px] text-center text-white_A700 w-[auto]">
                        Review product
                      </Button>
                    </div>
                  </div>
