                  ...
                  <div className="bg-white_A700 flex md:flex-1 items-center justify-start p-[32px] sm:px-[20px] rounded-[4px] shadow-bs md:w-[100%] w-[24%]">
                    <div className="flex flex-col items-start justify-start mb-[8px] w-[100%]">
                      <div className="flex flex-col gap-[24px] items-center justify-start w-[100%]">
                        ...
                        <Button
                          className="bg-deep_orange_300 flex items-center justify-center pl-[29px] pr-[35px] py-[17px] rounded-[24px] sm:px-[20px] text-center"
                          rightIcon={
                            <Img
                    ...
                    <div className="flex flex-col gap-[30px] items-center justify-start mb-[3px] md:w-[100%] w-[99%]">
                      ...
                      <div className="flex flex-col items-center justify-start w-[100%]">
                        <div className="flex md:flex-col flex-row md:gap-[20px] items-center justify-start w-[100%]">
                          ...
                          >
                            <div className="border-[1px] border-indigo_51 border-solid flex items-center justify-start sm:ml-[0] p-[12px] w-[100%]">
                              <Text
                                className="font-semibold mb-[5px] text-bluegray_800 text-left w-[auto]"
                                as="h5"
                                variant="h5"
                              >
                                Sun 2/1
                          ...
                          <div className="border-[1px] border-indigo_51 border-solid flex md:flex-1 items-center justify-start p-[12px] md:w-[100%] w-[auto]">
                            <Text
                              className="font-semibold mb-[5px] text-bluegray_800 text-left w-[auto]"
                              as="h5"
                              variant="h5"
                        ...
                        >
                          <div className="bg-deep_orange_300 flex flex-row gap-[9px] items-start justify-start mb-[536px] md:ml-[0] ml-[101px] p-[4px] rounded-[4px] md:w-[100%] w-[14%]">
                            <div className="flex flex-row gap-[8px] items-end justify-center mb-[6px] ml-[12px] w-[71%]">
                              <div className="bg-white_A700 h-[8px] mt-[7px] rounded-[50%] w-[8px]"></div>
                              <Text
                            ...
                            <Text
                              className="font-semibold mb-[6px] text-left text-white_A700 w-[auto]"
                              as="h6"
                              variant="h6"
                            >
                              Mêt
