          ...
          <div className="flex flex-1 flex-col items-center justify-start md:px-[20px] w-[100%]">
            ...
            <div className="bg-gray_51 flex items-center justify-end p-[23px] sm:px-[20px] w-[100%]">
              <div className="flex flex-col gap-[36px] items-center justify-start mb-[8px] mt-[14px] md:w-[100%] w-[99%]">
                ...
                <div className="flex md:h-[800px] h-[802px] justify-end relative w-[100%]">
                  ...
                  <div className="absolute bg-white_A700 flex flex-col gap-[16px] h-[100%] inset-[0] items-center justify-center m-[auto] p-[114px] sm:px-[20px] md:px-[40px] rounded-[4px] shadow-bs w-[100%]">
                    <Img
                      src="images/img_creditcardpay.svg"
                      className="h-[270px] w-[270px]"
                      alt="creditcardpay"
                    />
                    <div className="flex flex-col gap-[13px] items-center justify-start mb-[226px] pt-[4px] px-[4px] md:w-[100%] w-[auto]">
                      <Text
