            ...
            <div className="bg-gray_51 flex items-center justify-end p-[23px] sm:px-[20px] w-[100%]">
              <div className="flex flex-col gap-[35px] items-center justify-start mt-[15px] w-[100%]">
                ...
                <div className="bg-white_A700 flex flex-col items-center justify-start p-[48px] sm:px-[20px] md:px-[40px] rounded-[4px] shadow-bs w-[100%]">
                    ...
                    <div className="flex flex-col gap-[36px] justify-start mt-[79px] md:w-[100%] w-[95%]">
                      ...
                      <div className="flex flex-row gap-[24px] items-center justify-end ml-[auto] md:w-[100%] w-[23%]">
                        <Button className="bg-white_A700 flex h-[54px] items-center justify-center p-[15px] rounded-[50%] shadow-bs w-[54px]">
                          <Img
                            src="images/img_buttonprimary_8.svg"
                            className="h-[24px]"
                            alt="ButtonPrimary"
                          />
                        </Button>
                        <Button className="bg-white_A700 flex h-[54px] items-center justify-center p-[15px] rounded-[50%] shadow-bs w-[54px]">
                          <Img
                            src="images/img_buttonprimary_9.svg"
                            className="h-[24px]"
                  ...
                  <Button className="bg-deep_orange_300 cursor-pointer font-bold min-w-[270px] mt-[50px] py-[15px] rounded-[24px] text-[14px] text-center text-white_A700 w-[auto]">
                    Finish process
                  </Button>
                </div>
              </div>
