          ...
          <aside className="flex flex-col md:hidden justify-start md:px-[20px] w-[241px]">
            <div className="bg-white_A700 flex flex-col gap-[36px] items-center justify-start p-[29px] sm:px-[20px] w-[100%]">
              ...
              <div className="flex flex-col items-start justify-start mb-[422px] md:w-[100%] w-[87%]">
                ...
                <div className="flex flex-row gap-[34px] items-start justify-between md:ml-[0] ml-[3px] mt-[32px] md:w-[100%] w-[99%]">
                  <div className="flex flex-row gap-[16px] items-start justify-start mt-[2px] w-[auto]">
                    <Img
                    ...
                    />
                    <Text
                      className="font-medium mt-[4px] text-bluegray_400 text-left w-[auto]"
                      as="h6"
                      variant="h6"
                    >
                      Message
              ...
              <div className="flex flex-col gap-[35px] items-center justify-start mt-[15px] w-[100%]">
                ...
                <div className="bg-white_A700 flex items-center justify-start p-[32px] sm:px-[20px] rounded-[4px] shadow-bs w-[100%]">
                  <div className="flex flex-col items-center justify-start mb-[16px] mt-[20px] w-[100%]">
                    ...
                    <SelectBox
                      className="bg-white_A700 border-[1px] border-indigo_51 border-solid font-medium mt-[24px] pl-[20px] py-[19px] rounded-[4px] text-[16px] text-bluegray_800 text-left sm:w-[100%] w-[31%]"
                    ...
                    <div className="flex md:flex-col flex-row gap-[20px] items-center justify-between mt-[40px] w-[100%]">
                      <div className="border-[2px] border-dashed border-indigo_51 flex md:flex-1 items-center justify-start p-[34px] sm:px-[20px] rounded-[4px] md:w-[100%] w-[50%]">
                        <div className="h-[291px] relative w-[100%]">
                          <Img
                            ...
                            alt="imageFive"
                          />
                          <Button className="absolute bg-white_A700 bottom-[10%] flex h-[54px] items-center justify-center p-[15px] right-[6%] rounded-[50%] shadow-bs w-[54px]">
                            <Img
                              src="images/img_buttonprimary_54X54.svg"
                              className="h-[24px]"
                              alt="ButtonPrimary"
                            />
                          </Button>
                      ...
                      <div className="md:h-[291px] h-[359px] relative md:w-[100%] w-[50%]">
                        <Img
                          src="defaultNoData.png"
                          className="h-[291px] m-[auto] object-cover rounded-[16px] w-[86%]"
                          alt="imageSix"
                        />
                        <div className="absolute border-[2px] border-dashed border-indigo_51 h-[359px] md:h-[54px] inset-[0] justify-center m-[auto] p-[64px] sm:px-[20px] md:px-[40px] rounded-[4px] w-[100%]">
                          <Button className="absolute bg-white_A700 bottom-[0] flex h-[54px] items-center justify-center p-[15px] right-[18%] rounded-[50%] shadow-bs w-[54px]">
                            <Img
                              src="images/img_buttonprimary_54X54.svg"
                              className="h-[24px]"
