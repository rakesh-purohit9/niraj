            ...
            <div className="bg-gray_51 flex items-center justify-end p-[23px] sm:px-[20px] w-[100%]">
              <div className="flex flex-col gap-[35px] items-center justify-start mt-[15px] w-[100%]">
                ...
                <div className="bg-white_A700 flex flex-col gap-[40px] items-center justify-start p-[48px] sm:px-[20px] md:px-[40px] rounded-[4px] shadow-bs w-[100%]">
                  <div className="flex flex-col gap-[20px] items-center justify-end p-[4px] md:w-[100%] w-[auto]">
                    <Text
                  ...
                  <div className="flex flex-col relative sm:w-[100%] w-[56%]">
                    <div className="h-[504px] mx-[auto] w-[100%]">
                      ...
                      />
                      <div
                        className="absolute bg-cover bg-no-repeat md:h-[377px] h-[504px] inset-[0] justify-center m-[auto] p-[62px] sm:px-[20px] md:px-[40px] w-[100%]"
                        style={{
                          backgroundImage: "url('images/img_group2519.svg')",
                        }}
                      >
                        <Img
                          src="images/img_group_white_A700_377X459.svg"
                          className="absolute h-[377px] inset-[0] justify-center m-[auto] w-[auto]"
                          alt="Group One"
                        />
                      </div>
                    </div>
                    <div className="bg-deep_orange_300 md:h-[11px] h-[80px] mt-[-17px] mx-[auto] outline outline-[4px] outline-white_A700 p-[26px] sm:px-[20px] rounded-[50%] w-[80px] z-[1]">
                      <Img
                        src="images/img_camera.svg"
                        className="absolute h-[28px] inset-[0] justify-center m-[auto] w-[28px]"
                        alt="camera"
                      />
                    </div>
                  </div>
