          ...
          <div className="flex flex-1 flex-col items-center justify-start md:px-[20px] w-[100%]">
            ...
            <div className="bg-gray_51 flex items-center justify-end p-[23px] sm:px-[20px] w-[100%]">
              <div className="flex flex-col gap-[35px] items-center justify-start mt-[15px] w-[100%]">
                ...
                <div className="bg-white_A700 flex flex-col md:gap-[40px] gap-[80px] items-center justify-start p-[103px] sm:px-[20px] md:px-[40px] rounded-[4px] shadow-bs w-[100%]">
                  <Img
                    src="images/img_group18034.svg"
                    className="h-[215px] w-[auto]"
                    alt="Group18034"
                  />
                  <div className="flex flex-col gap-[32px] justify-start mb-[130px] md:w-[100%] w-[50%]">
                    ...
                    <Button className="bg-deep_orange_300 cursor-pointer font-bold min-w-[207px] md:ml-[0] ml-[143px] mr-[115px] py-[15px] rounded-[24px] text-[14px] text-center text-white_A700 w-[auto]">
                      Explore product
                    </Button>
                  </div>
                </div>
